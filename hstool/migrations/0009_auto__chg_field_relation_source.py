...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relation.source'
        db.alter_column(u'hstool_relation', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hstool.DriverOfChange']))

    def backwards(self, orm):

        # Changing field 'Relation.source'
        db.alter_column(u'hstool_relation', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hstool.GenericElement']))
    ...
    models = {
        ...
        u'hstool.relation': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '2048'}),
            'destination': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dest_relations'", 'blank': 'True', 'to': u"orm['hstool.GenericElement']"}),
            'figures': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['hstool.Figure']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'relationship_type': ('django.db.models.fields.IntegerField', [], {}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'source_relations'", 'to': u"orm['hstool.DriverOfChange']"})
        },
        u'hstool.source': {
