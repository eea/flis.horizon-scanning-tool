...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Figure.draft'
        db.add_column(u'hstool_figure', 'draft',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Relation.draft'
        db.add_column(u'hstool_relation', 'draft',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'GenericElement.draft'
        db.add_column(u'hstool_genericelement', 'draft',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Source.draft'
        db.add_column(u'hstool_source', 'draft',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Assessment.draft'
        db.add_column(u'hstool_assessment', 'draft',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Figure.draft'
        db.delete_column(u'hstool_figure', 'draft')

        # Deleting field 'Relation.draft'
        db.delete_column(u'hstool_relation', 'draft')

        # Deleting field 'GenericElement.draft'
        db.delete_column(u'hstool_genericelement', 'draft')

        # Deleting field 'Source.draft'
        db.delete_column(u'hstool_source', 'draft')

        # Deleting field 'Assessment.draft'
        db.delete_column(u'hstool_assessment', 'draft')
