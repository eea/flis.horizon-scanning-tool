...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.geographical_scope'
        db.add_column(u'hstool_assessment', 'geographical_scope',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeographicalScope'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assessment.country'
        db.add_column(u'hstool_assessment', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assessment.url'
        db.add_column(u'hstool_assessment', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.geographical_scope'
        db.delete_column(u'hstool_assessment', 'geographical_scope_id')

        # Deleting field 'Assessment.country'
        db.delete_column(u'hstool_assessment', 'country_id')

        # Deleting field 'Assessment.url'
        db.delete_column(u'hstool_assessment', 'url')
