...
from auth.views import (
    EditPermissionRequiredMixin, AdminPermissionRequiredMixin,
)
...
class AssessmentsUpdate(ContextMixin, EditPermissionRequiredMixin, UpdateView):
    template_name = 'tool/assessments_add.html'
    model = Assessment
    form_class = AssessmentForm
...
class SourcesUpdate(EditPermissionRequiredMixin, UpdateView):
    template_name = 'tool/sources_add.html'
    model = Source
    form_class = SourceForm
    success_url = reverse_lazy('sources:list')
...
class DriversUpdate(EditPermissionRequiredMixin, UpdateView):
    template_name = 'tool/drivers_add.html'
    model = DriverOfChange
    form_class = DriverForm
    success_url = reverse_lazy('drivers:list')
...
class FiguresUpdate(EditPermissionRequiredMixin, UpdateView):
    template_name = 'tool/figures_add.html'
    model = Figure
    form_class = FigureForm
    success_url = reverse_lazy('figures:list')
...
class CountriesList(AdminPermissionRequiredMixin, ListView):
    template_name = 'tool/countries_list.html'
    model = Country
    context_object_name = 'countries'


class CountriesAdd(AdminPermissionRequiredMixin, CreateView):
    template_name = 'tool/countries_add.html'
    form_class = CountryForm
    success_url = reverse_lazy('settings:countries_list')


class CountriesUpdate(AdminPermissionRequiredMixin, UpdateView):
...
class CountriesDelete(ContextMixin, AdminPermissionRequiredMixin, DeleteView):
    template_name = 'tool/object_delete.html'
    model = Country


class GeoScopesList(AdminPermissionRequiredMixin, ListView):
    template_name = 'tool/geo_scopes_list.html'
    model = GeographicalScope
    context_object_name = 'geo_scopes'


class GeoScopesAdd(AdminPermissionRequiredMixin, CreateView):
    template_name = 'tool/geo_scopes_add.html'
    form_class = GeoScopeForm
    success_url = reverse_lazy('settings:geo_scopes_list')


class GeoScopesUpdate(AdminPermissionRequiredMixin, UpdateView):
    template_name = 'tool/geo_scopes_add.html'
    model = GeographicalScope
    form_class = GeoScopeForm
    success_url = reverse_lazy('settings:geo_scopes_list')
...
class GeoScopesDelete(ContextMixin, AdminPermissionRequiredMixin, DeleteView):
    template_name = 'tool/object_delete.html'
    model = GeographicalScope
